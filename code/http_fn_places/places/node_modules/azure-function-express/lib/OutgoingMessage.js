...
function writeHead(context, statusCode, statusMessage, headers) {
  ...
  if (typeof statusMessage === "string") {
    ...
    this.statusMessage = _statusCodes.default[statusCode] || "unknown";
  } // 3. Headers
  ...
  context.res.status = statusCode; // In order to uniformize node 6 behaviour with node 8 and 10,
...
class OutgoingMessage extends _http.OutgoingMessage {
  /**
  ...
  constructor(context) {
    ...
    this._headerNames = {};
    this._removedHeader = {};
    this._hasBody = true; // Those methods cannot be prototyped because express explicitelly overrides __proto__
