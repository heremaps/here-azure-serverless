 ...
 */
 ...
 /* Azure Serverless Function generic Handler for HERE Location Suite.
  * Caters to below 7 APIs from HERE Location Suite:
  * 1. Geocoder 
  * 2. Positioning
  * 3. Routing
  * 4. Places
...
module.exports = async function(context, eventHubMsg) {
    ...
    // Input request object/eventHubMsg should be in JSON format
    // Fields required are:
    /*
