...
/* Azure Serverless Function for Public Transit API
 * Covers all resources available under Public Transit as below.
 * 
 * HERE Public Transit Coverage
 * HERE Public Transit Line Info
 * HERE Public Transit Nearby Departures
 * HERE Public Transit Isochrome
 * HERE Public Transit Alerts
 * HERE Public Transit Logo Brands
 * HERE Public Transit Route Section Update
 * HERE Public Transit Earlier/Later journeys.
...
// API URL
const HERE_API_URL = config.authUrls.HERE_PUBLIC_TRANSIT_URL;

app.all("/api/public_transit/*", asyncMiddleware(async(req, res) => {
